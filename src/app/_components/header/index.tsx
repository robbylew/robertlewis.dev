...
export function Header() {
  ...
  return (
    <header
      ...
      className="fixed left-3 right-3 top-3 z-50 rounded-xl border border-neutral-100 bg-neutral-50/80 py-3 backdrop-blur transition-all dark:border-neutral-900 dark:bg-neutral-1000/80 md:left-0 md:right-0 md:top-0 md:w-full md:rounded-none md:border-x-0 md:border-b md:border-t-0 data-[on-top='false']:md:border-b-neutral-100 data-[on-top='true']:md:border-b-transparent data-[on-top='true']:md:py-6 data-[on-top='false']:md:dark:border-b-neutral-900/80"
    >
      <div className="content-container m-auto flex flex-wrap items-center justify-center">
        <div className="md:hidden" />
        <Link
          href="/"
          className="font-handwrite text-2xl font-bold drop-shadow-lg md:hidden"
        >
          Robert Lewis
        </Link>
        <div className="hidden flex-wrap items-center justify-center gap-8 md:flex">
          <nav className="flex flex-wrap items-center justify-center gap-5">
            ...
            <MenuItem name="TIL" path="/blog/til" />
