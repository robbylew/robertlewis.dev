...
export async function GET(
  ...
  const uiByTheme = {
    light: {
      ...
      text: '#000',
      serverImage:
        'https://raw.githubusercontent.com/robbylew/robertlewis.dev/cfc774a3020ea9815694f129951ef3f286701b13/public/assets/server-status-bro-light.svg'
    },
    dark: {
      bg: '#000',
      text: 'rgb(250,250,250)',
      serverImage:
        'https://raw.githubusercontent.com/robbylew/robertlewis.dev/cfc774a3020ea9815694f129951ef3f286701b13/public/assets/server-status-bro-dark.svg'
    }
  }
  ...
  return new ImageResponse(
    (
      ...
      >
        <img
          alt=""
          src="https://raw.githubusercontent.com/robbylew/robertlewis.dev/cfc774a3020ea9815694f129951ef3f286701b13/public/assets/robin-bird-bro.svg"
          style={{
            position: 'absolute',
            width: 300,
            left: 0,
